  ...
  return (
    <section className={styles.dropdown} aria-label={title}>
      <div className={styles.dropdown_title}>
        ...
        <div
          className={dropdown ? styles.dropdown_title_vector_up : styles.dropdown_title_vector_down}
          onClick={handleClick}
          aria-label="Toggle dropdown"
          role="button"
        ></div>
      </div>
      <div className={dropdown ? styles.dropdown_content : styles.dropdown_content_hidden}>
